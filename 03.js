...
async function runTasksSequential() {
  ...
  // 예상되는 대략적인 시간과 그 이유 < 6초, 각각의 모든 함수를 실행하고 (3초) runTasksSequential()함수에서 함수들 재실행 마지막함수의 대기시간은 3초 3 + 3 = 6초 >
}
...
async function runTasksParallel() {
  ...
  // 예상되는 대략적인 시간과 그 이유 < 3초, 모든 함수를 병렬로 동시에 실행하고 마지막함수의 대기시간은 3초 >
}
